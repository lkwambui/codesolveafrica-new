      ...
      <Container className="py-16">
        ...
        <div className="mt-8 pt-6 border-t border-border dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-xs text-secondary-text dark:text-white/60">
            <Link to="/faq" className="hover:text-primary-blue transition-colors">Privacy Policy</Link>
            <Link to="/faq" className="hover:text-primary-blue transition-colors">Terms of Service</Link>
            <Link to="/faq" className="hover:text-primary-blue transition-colors">Cookie Policy</Link>
          </div>
        </div>
      </Container>
    </footer>
