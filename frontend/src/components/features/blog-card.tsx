  ...
  return (
    ...
    >
      <Link href={`/blog/${slug}`} className="group block">
        <div className="rounded-2xl border border-border bg-white p-6 transition-all duration-300 hover:shadow-elevated hover:border-primary-blue/20">
          ...
          <h3 className="font-heading text-lg font-semibold text-primary-text group-hover:text-primary-blue transition-colors leading-snug">
            {title}
          </h3>
